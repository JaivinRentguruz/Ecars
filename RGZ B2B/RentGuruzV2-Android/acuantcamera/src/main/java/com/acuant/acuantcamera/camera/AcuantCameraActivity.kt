...
import kotlinx.android.synthetic.main.activity_acu_camera.*
...
class AcuantCameraActivity : AppCompatActivity(), ICameraActivityFinish {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (supportCamera2(this)) {
            ...
            scanview.setBackgroundColor(Color.parseColor(intent.getStringExtra("second")))
            screenview.setBackgroundColor(Color.parseColor(intent.getStringExtra("first")))
            lbl_enter_details.setBackgroundColor(Color.parseColor(intent.getStringExtra("first")))
            ...
            back.setOnClickListener {
               ...
               // onBackPressed()
                ...
                this@AcuantCameraActivity.setResult(123, intent)
                //this@AcuantCameraActivity.setResult(RESULT_SUCCESS_CODE, intent)
                this@AcuantCameraActivity.finish()
            }

            lbl_enter_details.setOnClickListener {
                isBack = true
                // onBackPressed()
                val intent = Intent()

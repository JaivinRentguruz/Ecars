...
import com.rentguruz.app.b2b.galadariauto.adapters.RequestPermissionHandler;
import com.rentguruz.app.b2b.galadariauto.base.BaseFragment;
import com.rentguruz.app.b2b.galadariauto.databinding.FragmentHomeBinding;
import com.rentguruz.app.b2b.galadariauto.model.display.HomeScreen;
import com.rentguruz.app.b2b.galadariauto.model.response.CompanyLabel;
...
public class Fragment_Home_Tab extends BaseFragment
{
    ...
    RequestPermissionHandler loctionpermission;
    @Override
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState)
    {
      ...
      //  getview.getCompanyLabel(view, companyLabel);
        ...
        Log.e(TAG, "onViewCreated: " + Helper.currencySymbol );

        loctionpermission = new RequestPermissionHandler(getActivity(), this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION});
        if (loctionpermission.checkpermission()){
        }
       ...
       /* lblAgreement.setOnClickListener(new View.OnClickListener()
        ...
        if (ActivityCompat.checkSelfPermission(getActivity(), Manifest.permission.ACCESS_FINE_LOCATION) != PermissionChecker.PERMISSION_GRANTED) {
        ...
        if (ActivityCompat.checkSelfPermission(getActivity(), Manifest.permission.WRITE_EXTERNAL_STORAGE) != PermissionChecker.PERMISSION_GRANTED) {

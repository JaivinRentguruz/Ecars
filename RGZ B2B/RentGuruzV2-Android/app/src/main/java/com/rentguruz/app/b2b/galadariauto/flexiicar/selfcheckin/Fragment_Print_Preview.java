...
import com.rentguruz.app.b2b.galadariauto.databinding.FragmentPrintPreviewBinding;
import com.rentguruz.app.b2b.galadariauto.model.parameter.ReportType;
...
import static com.rentguruz.app.b2b.galadariauto.apicall.ApiEndPoint.REPORT;
...
public class Fragment_Print_Preview extends BaseFragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.header.screenHeader.setText("Agreement Print");
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.home:
                NavHostFragment.findNavController(Fragment_Print_Preview.this)
                        .navigate(R.id.action_LocationKey_ForSelfCheckOut,bundle);
                break;
        }
    }

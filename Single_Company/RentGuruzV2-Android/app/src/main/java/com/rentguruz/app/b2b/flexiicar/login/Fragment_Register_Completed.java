...
import com.rentguruz.app.b2b.databinding.FragmentRegistrationCompletedBinding;
                        ...
                        && ActivityCompat.checkSelfPermission(getActivity(), Manifest.permission.READ_EXTERNAL_STORAGE)!= PackageManager.PERMISSION_GRANTED)
                {
                ...
                else
                    {
                        ...
                        try
                        {
                            ...
                            bodyParam.accumulate("CompanyId",Integer.valueOf(loginRes.getData("CompanyId")));

...
import com.rentguruz.app.b2b.databinding.FragmentNewAgreementBinding;
...
import com.rentguruz.app.b2b.model.parameter.enums.RecurringRsvBillingCycle;
...
import static com.rentguruz.app.b2b.apicall.ApiEndPoint.RANDUMNUMBERS;
import static com.rentguruz.app.b2b.apicall.ApiEndPoint.RATE;
import static com.rentguruz.app.b2b.apicall.ApiEndPoint.SUMMARYCHARGE;
import static com.rentguruz.app.b2b.model.parameter.enums.RecurringRsvBillingCycle.*;
     ...
     //   new ApiService(getReservationNumber, RequestType.GET,RANDUMNUMBERS,BASE_URL_LOGIN, header, "?length=8&prefix=8");
        ...
        binding.leftscreen.fixrate.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                getChecked();
                userDraw.toggle(binding.leftscreen.fixrate, isChecked);
                /*if (isChecked){
        ...
        binding.leftscreen.unlimitedMiles.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                userDraw.toggle(binding.leftscreen.unlimitedMiles,isChecked );
                getChecked();
        ...
        binding.leftscreen.customeRate.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                userDraw.toggle(binding.leftscreen.customeRate, isChecked);
                if (isChecked) {
                    getCustomeRate();
                } else {
                    binding.leftscreen.promocode.setChecked(true);

...
import com.rentguruz.app.b2b.databinding.FragmentHomeBinding;
import com.rentguruz.app.b2b.home.testdesign.MembershipPlan;
        ...
        try {
            ...
            try {
             ...
             //  String datas =  UserData.loginResponse.User.UserName.split(" ")[1];
                setText(binding.details.l, UserData.loginResponse.User.FirtName);
                setText(binding.details.f, UserData.loginResponse.User.LastName);
            } catch (Exception e){
                e.printStackTrace();
